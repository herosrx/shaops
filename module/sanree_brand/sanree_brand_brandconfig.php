 ...
 *
 *      $Id: sanree_brand_brandconfig.php 2014-07-29 10:20:00 sanree checkedby liuhuan $
 */
...
$subdo = $_G['sr_subdo'];
$dostr = $do;
if(!in_array($do, array('main', 'config', 'banner', 'body', 'weixin', 'mf', 'tag'))) {
	$do = 'main';
	$dostr = $subdo;  
	if(!in_array($subdo, array('config', 'banner', 'body', 'weixin', 'mf', 'tag'))) {
		$dostr = 'config';
	}
}
