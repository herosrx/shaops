<?php (!defined('IN_SANREE')&&exit('Power By adminbuy.cn'))?>
	...
	<div class="sanree_brand_business">
		...
		<div class="sanree_brand_right">
		 ...
		 <div class="copyright mtop">
			 ...
			 <dd class="sanreecom">&copy;&nbsp;<a href="http://www.adminbuy.cn/" target="_blank">AdminBuy.Cn</a></dd>
			 <dd>{lang sanree_brand:support}<a href="http://www.yiquantou.com/" target="_blank">Yiquantou.Com</a></dd>
			 </dl>
		 </div>	
		 <!--{else}-->
