				...
				xmlhttp.onreadystatechange=function() {
					...
					if (xmlhttp.readyState==4 && xmlhttp.status==200) {
						if(xmlhttp.responseText) {
							...
							//setTimeout("document.getElementById('success').style.visibility = 'hidden'", 1000);
							
						}
						//document.getElementById("txtHint").innerHTML=xmlhttp.responseText;
					} else if (xmlhttp.readyState==1 && xmlhttp.status==0) {
					
						/*obj.innerHTML = '{lang sanree_brand:assistly}';
						obj.onmouseout = function() {
							obj.innerHTML='{lang sanree_brand:assist_befor}'+count+'{lang sanree_brand:assist_after}';
						}*/
