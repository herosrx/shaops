...
if ($do == 'upgrading') {
	...
	if(submitcheck('addsubmit')){
		...
		array(
			...
			'<li style="float:right"><a href="http://dx.sanree.com/forum-82-1.html" target="_blank"><span style="color:#FF0000;text-decoration:underline;">'.$langs['sanreetemplate'].'</span></a></li>'.			
			'</ul>'
		));
		showtablefooter();		
		if($diystyleid>0) {
