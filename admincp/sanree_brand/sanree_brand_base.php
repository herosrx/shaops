...
<?php	
	...
	$siteurl = urlencode("http://www.fqjz0591.com/");
?>
	<script language="javascript">disallowfloat = 'newthread';</script>
		...
		var SN='2014042523s4K4QUOUT9';
		var RevisionID='5057';
		var RevisionDateline='1411992002';
		var SiteUrl='http://www.fqjz0591.com/';
		var ClientUrl='http://qu.ganjicn.com/';
		var SiteID='D4DAB6BB-C711-CDBD-F0C7-A2F6C864D319';		
		var src= 'http://a.sanree.com/api.php?type=js&SN='+SN + '&RevisionID='+ RevisionID + '&RevisionDateline='+RevisionDateline+ '&SiteUrl='+SiteUrl+ '&ClientUrl='+ClientUrl+'&SiteID='+SiteID;
		</script>	
<?php if ($mapapi=='baidu'){ ?>	
...
<TD class="vtop tips2" s="111"><a href="plugin.php?id=sanree_brand&mod=map&do=marked" id="showmap" onclick="showWindow('showmap',this.href);return false;"><?php echo $langs['marked']?></a> &nbsp;&nbsp;<a href="###" onclick="copymap()" ><?php echo $langs['copymappos']?></a></TD></TR>
  ...
  <tr>
	...
	?>
	  <tr>
		<td>		
		<iframe src="http://a.sanree.com/ad.php?sitedata=<?php echo $sitedata?>" width="100%" height="200" scrolling="yes" frameborder="0"></iframe></td>
	  </tr>
	  <script language="javascript">
